...
% Correction or Regularization
correct = ( sum(sum(thetaNoZero1 .^ 2))+ sum(sum(thetaNoZero2 .^ 2)));

J = (1 / m) * sum(sum(cost,2)) + (lambda / (2 * m)) * correct;
...
p1= (lambda/m)* thetaNoZero1;
p2= (lambda/m)* thetaNoZero2;
